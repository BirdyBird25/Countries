...
public class Main 
{
  ...
  public void loadCountries() 
  {
    ...
    for (int i = 0; i < countryArray.length; i++ ) {
      ...
      Country Turkey = new Country(data[0], data[1], data[2], data[3]);

      countryArray[i] = Turkey;
  ...
  */
  public void quizButtonClick()
  {
    ...
    outputLabel.setText("");
    System.out.println(countryArray[index].getName());

      if (input.getText().equals(countryArray[index].getName()) && !input.getText().contains("")) {//also making sure user hasn't inputted anything
        outputLabel.setText("Correct!");

      } else if (!(input.getText().equals(countryArray[index].getName()))) {
        outputLabel.setText("Incorrect!");
      }
        else {//if the user hasn't inputted anything yet
          outputLabel.setText("");
        } 
      }
